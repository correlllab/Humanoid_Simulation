...
from .exampleproject_marl_env_cfg import ExampleprojectMarlEnvCfg


class ExampleprojectMarlEnv(DirectMARLEnv):
    cfg: ExampleprojectMarlEnvCfg

    def __init__(self, cfg: ExampleprojectMarlEnvCfg, render_mode: str | None = None, **kwargs):
